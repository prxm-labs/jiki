      ...
      {showHeader && (
        <header className="flex items-center justify-between px-4 h-10 border-b border-zinc-800 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Persistence</span>
          </div>
          <span className="text-[10px] font-mono text-zinc-500">{entryCount} entries persisted</span>
        </header>
      )}
