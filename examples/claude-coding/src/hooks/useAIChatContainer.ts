    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <nav className="border-b border-black/10">
        <div className="max-w-2xl mx-auto px-6 h-12 flex items-center justify-between">
          <span className="text-sm font-bold tracking-tight">claude.</span>
      ...
      <section className="max-w-2xl mx-auto px-6 pt-20 pb-16">
        <p className="text-xs font-medium uppercase tracking-widest text-black/40 mb-4">Claude Opus 4.6</p>
        <h1 className="text-5xl font-black leading-[1.1] tracking-tight mb-4">
          Describe it.<br/>Watch it build.
        </h1>
        <p className="text-base text-black/50 leading-relaxed max-w-md mb-10">
          Type a component description in the chat panel. Claude generates production-ready React code that renders live.
        </p>
      ...
      <section className="border-t border-black/10">
        <div className="max-w-2xl mx-auto px-6 py-12">
          <div className="grid grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-sm font-bold mb-1">History</h3>
              <p className="text-xs text-black/40 leading-relaxed">Conversations persist in IndexedDB across sessions.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-black/10 mt-8">
        <div className="max-w-2xl mx-auto px-6 py-6 flex items-center justify-between">
          <span className="text-xs font-bold tracking-tight">claude.</span>
          <span className="text-xs text-black/30">Anthropic &middot; jiki</span>
        </div>
      </footer>
    </div>
  );
...
export function useAIChatContainer() {
  ...
  const [needsApiKey, setNeedsApiKey] = useState(() => typeof window !== 'undefined' ? !getApiKey() : true);
