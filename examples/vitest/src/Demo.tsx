      ...
      {showHeader && (
        <header className="flex items-center justify-between px-4 h-10 border-b border-zinc-800 flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={runTests} disabled={isRunning} className="px-2.5 py-1 text-[10px] font-mono font-medium rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-500/20 disabled:opacity-40 transition-colors">
