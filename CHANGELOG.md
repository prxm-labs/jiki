...
First stable release of jiki-ui React component library.

### 0.0.1-beta.5

Initial release with CodeEditor, Terminal, BrowserWindow, FileExplorer, AIChatPanel, MobileTabBar, and PanelToggle components.
